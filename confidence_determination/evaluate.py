...
def evaluate(Yh,Y,Yc):
    ...
    return {
        '1. Accuracy': raw_acc
        ,'2. 0.8 quantile of confidence accuracy': high_q_acc
        ,'3. 0.5 quantile of confidence accuracy': avg_q_acc
        ,'4. Subset acc/conf': sub_acc_conf
        ,'5. Full dataset acc/conf':full_acc_conf
        ,'6. Confidence weighted accuracy': weighted_acc
    }
